...
public class ProfilDoseCursorAdapter extends CursorAdapter {
    ...
    public ProfilDoseCursorAdapter(Context context, Cursor c, int flags, BtnClickListener deleteFunction) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView t2 = view.findViewById(R.id.DOSE_CELL);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return mInflater.inflate(R.layout.row_profilmedication, parent, false);
    }

    /*
     * @pColor :Wir adden die Farbe
     */

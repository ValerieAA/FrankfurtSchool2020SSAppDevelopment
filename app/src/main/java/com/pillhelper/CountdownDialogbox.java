...
import com.pillhelper.utils.AlarmReceiver;
...
public class CountdownDialogbox extends Dialog implements
    ...
    private float lTotalMedication = 0;
...
*/
    ...
    public void setTotalDoseSession(float pTotalDose) {
        lTotalSession = pTotalDose;
    }

    public void setTotalDoseMedication(float pTotalDose) {
        lTotalMedication = pTotalDose;
    }

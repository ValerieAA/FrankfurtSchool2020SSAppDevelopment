...
public class RecordCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView tExercise = view.findViewById(R.id.MED_CELL);
        tExercise.setText(cursor.getString(cursor.getColumnIndex(DAORecord.MEDICATION)));

        TextView tSerie = view.findViewById(R.id.INTAKE_CELL);
        TextView tSerieLabel = view.findViewById(R.id.SERIE_LABEL);
        TextView tReps = view.findViewById(R.id.DOSE_CELL);
        TextView tWeight = view.findViewById(R.id.MED_CELL);
        TextView tWeightLabel = view.findViewById(R.id.WEIGHT_LABEL);
        //LinearLayout tSerieLayout = view.findViewById(R.id.SERIE_LAYOUT);
        LinearLayout tRepsLayout = view.findViewById(R.id.INTAKE_LAYOUT);
        ...
        if (recordType == DAOMedication.TYPE_FONTE) {
            // UI
            tSerieLabel.setText(mContext.getString(R.string.SerieLabel));
            tWeightLabel.setText(mContext.getString(R.string.DoseLabel));
            tRepsLayout.setVisibility(View.VISIBLE);
            // Data
            tSerie.setText(cursor.getString(cursor.getColumnIndex(DAORecord.SERIE)));
            tReps.setText(cursor.getString(cursor.getColumnIndex(DAORecord.INTAKE)));

            String unit = mContext.getString(R.string.mgUnitLabel);
            float poids = cursor.getFloat(cursor.getColumnIndex(DAORecord.DOSE));
        ...
        } else if (recordType == DAOMedication.TYPE_LONGTERM) {

...
public class MedicationMeasureCursorAdapter extends CursorAdapter {

    BtnClickListener mDeleteClickListener = null;
    private LayoutInflater mInflater;
    private Context mContext = null;

    public MedicationMeasureCursorAdapter(Context context, Cursor c, int flags, BtnClickListener mD) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView t1 = view.findViewById(R.id.LIST_MEDICATION_DATE);
        Date date;
        try {
        ...
        TextView t2 = view.findViewById(R.id.LIST_MEDICATION_GRAMS);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return mInflater.inflate(R.layout.medicationmeasure_row, parent, false);
    }

    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
           //Tabbed
            ...
            Intent i=new Intent(this, BasicListActivity.class);
            startActivity(i);
        ...
        switch (requestCode) {
            case 1234:
                if(resultCode=RESULT_CANCELED) {
                    ...
                    data.getLongExtra("calculatedResult",-1L);
                    boolean wasNull = data.getExtras().containsKey("calculatedResult");
                    //...
                }
                break;
        }
